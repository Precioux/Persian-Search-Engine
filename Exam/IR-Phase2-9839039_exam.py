...
def openFiles():
    ...
    file_path = 'C:/Users/Samin/Desktop/University/Term 7/Information Retrieval/Project/Data/IR_data_news_5k_positional_index_dic.json'
    try:
    ...
    # Opening origin file
    file_path = 'C:/Users/Samin/Desktop/University/Term 7/Information Retrieval/Project/Data/IR_data_news_5k.json'
    try:
        with open(file_path, 'r', encoding='utf-8') as f:
    ...
    file_path = 'C:/Users/Samin/Desktop/University/Term 7/Information Retrieval/Project/Data/IR_data_news_5k_preprocessed.json'
    try:
        with open(file_path, 'r', encoding='utf-8') as f:
